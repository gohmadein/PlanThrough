...
https://planthrough-workflow.lmx71017.chatgpt.site

- 当前版本：`公测版 v0.3.0`
- 左侧项目工作台提供“意见反馈”，可提交问题、期望效果、联系方式和不超过 5MB 的截图。
- 反馈会自动附带应用版本、浏览器和窗口尺寸，不会自动提交项目节点内容或本地附件。
- 当前项目和节点附件仍只保存在使用者自己的浏览器中，请勿上传机密文件，并定期导出项目 JSON 备份。
